...
final class TaskCreationExecution
{
    /**
    ...
    private function __construct(
        ...
        public readonly ?TaskCreationResult $result = null,
    ...
    public static function success(TaskCreationResult $result, bool $replayed = false): self
    {
    ...
    {
        return $this->state === 'success' && $this->result instanceof TaskCreationResult;
    }
}